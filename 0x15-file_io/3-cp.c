...
/**
 * check98 - check readable, and exists
 * @check: 10
 * @file: mefr ig
 * @fd_from: file descriptor ig
...
/**
 * check99 - checks file was created
 * @check: true of false
 * @file: name
...
/**
 * check100 - checkwhether file descriptors were closed properly
 * @check: 1 0
 * @fd: file descriptor
 *
 * Return: void
